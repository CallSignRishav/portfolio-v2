...
const AboutSection = () => {
	...
	return (
		<>
			<main className="font-inter space-y-20 py-24 text-white/80">
				<section
					id="about"
					...
					<p className="text-white/50">
						...
						degree in Arts and started my career working with Excel
						and Word in administrative roles. But something was
						missing.{" "}
						<span className="text-white">
							I wanted to build things
						</span>
						, not just manage data. So I took a leap, spent a year
						and a half{" "}
						<span className="text-white">
							teaching myself web development
						</span>{" "}
						from scratch. HTML, CSS, JavaScript, and everything that
						came after. It was intense, but I loved every minute of
						it.
					</p>

					<p className="text-white/50">
						That self-learning journey led to my first{" "}
						<span className="text-white">teaching role,</span> where
						I got to share HTML and CSS basics with new students.
						During that time, I also{" "}
						<span className="text-white">
							built my first real-world project
						</span>{" "}
						— a complete website for the institute. Seeing something
						I created actually being used by real people?{" "}
						<span className="text-white">
					...
					<p className="text-white/50">
						...
						that solves real problems without unnecessary
						complexity. Whether it&apos;s improving API response
						times through{" "}
						<span className="text-white">
						...
						I care about making things work well — not just making
						them work.
					</p>

					<p className="text-white/50">
						I&apos;m comfortable with the full development cycle —
						from{" "}
						<span className="text-white">
						...
						, to building responsive UIs with Tailwind CSS, to
						deploying{" "}
						<span className="text-white">
				...
				<section
					...
					<p className="">
						...
						elit. Ipsam, aut enim velit at aliquid atque veniam
						optio, animi soluta numquam ex ad nobis, natus dolores
						voluptatum quibusdam fugit est? A, fuga consectetur
						tempore dignissimos asperiores voluptates natus
						quibusdam odit dicta. Fugiat natus nisi aspernatur
						repellendus expedita tenetur porro eius, cupiditate
						ratione laudantium autem. Cum, accusantium!
					</p>
				</section>
